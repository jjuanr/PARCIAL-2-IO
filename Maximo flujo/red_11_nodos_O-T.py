...
grafo = {
    'o': {'a': 4, 'b': 3, 'c': 6}, #El 1 va a 2 con un valor de 16, 1 va a 3 con valor de 20 y 1 va a 4 con valor de 6
    'a': {'c': 5, 'd': 3},
    'b': {'c': 4, 'e': 6},
    'c': {'d': 2, 'f': 2, 'e': 5},
    'd': {'f': 2, 'g': 10},
...
print("\nFlujo máximo:", edmonds_karp_no_inversos(grafo, 'o', 't')) #Poner el primer y ultimo grafo 